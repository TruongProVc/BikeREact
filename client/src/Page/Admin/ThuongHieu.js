          ...
          <table className="table text-nowrap mb-0 align-middle"> 
            <thead className="text-dark fs-4"> 
              <tr> 
                ...
                <th className="border-bottom-0 text-center"> 
                  <h6 className="fw-600 mb-0">Mô tả</h6> 
                </th> 
                <th className="border-bottom-0 text-center"> 
...
const Menu =()=>{
  return(
    ...
    <Link to="/addBrand" className="btn btn-success btn-sm">Thêm</Link> 
    <button className="btn btn-danger btn-sm">Xóa</button> 
    <Link to="/editBrand" className="btn btn-warning btn-sm">Sửa</Link> 
  </div>
  )
}
